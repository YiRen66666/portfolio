...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto overflow-hidden top-[102px]">
      <div className="absolute inset-0 z-0">
        <HeroSceneCanvas />
      </div>

      <div
        className={`pointer-events-none absolute inset-0 top-[22px] z-10 max-w-[1320px] mx-auto ${styles.paddingX} flex flex-row items-start gap-4`}
      >
        ...
        <div className="max-w-[640px] lg:max-w-[600px]">
          ...
          <div className={`${styles.heroSubSubText} pointer-events-auto mt-3 text-white-100`}>
            <a
